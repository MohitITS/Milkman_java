...
public class bank extends javax.swing.JInternalFrame {
    ...
    private void displayrecord(int flag) {
        if(framestate==3){
            try {
                ...
                String qry = null;
                if(flag==4){
                   qry = "SELECT * FROM bank WHERE ID=(SELECT max(ID) FROM bank);";
                }
                if(flag==1){
                   qry = "SELECT * FROM bank WHERE ID=(SELECT min(ID) FROM bank);";
                }
                if(flag==2){
                   qry = "SELECT * FROM bank WHERE ID<"+txtgroupid.getText()+" ORDER BY ID DESC;";
                }
                if(flag==3){
                   qry = "SELECT * FROM bank WHERE ID>"+txtgroupid.getText()+" ORDER BY ID;";
                }                
                ...
                while(rs.next()){
                    ...
                    String grpname = rs.getString("bankname");
                    //System.out.println(grpname);
                    //JOptionPane.showMessageDialog(null, grpname, title, JOptionPane.INFORMATION_MESSAGE);
                    txtgroup.setText(grpname);
                    txtgroup1.setText(rs.getString("branch"));
                    txtgroup2.setText(rs.getString("ifsccode"));
                    break;
                }
                rs.close();
                conn.close();
    ...
    private void emptyctr() {
        ...
        txtgroup1.setText(null);
        txtgroup2.setText(null);
    ...
    private void ED_BUTTONS(boolean f1, boolean f2) {
        ...
        txtgroup1.setEditable(f1);
        txtgroup2.setEditable(f1);
    ...
    private void initComponents() {
        ...
        txtgroup1.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N

        jLabel4.setFont(new java.awt.Font("Mangal", 1, 14)); // NOI18N
        jLabel4.setText("शाखा :");

        jLabel5.setFont(new java.awt.Font("Mangal", 1, 14)); // NOI18N
        jLabel5.setText("IFSC कोड :");

        txtgroup2.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtgroup1, javax.swing.GroupLayout.PREFERRED_SIZE, 283, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtgroup2, javax.swing.GroupLayout.PREFERRED_SIZE, 283, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(ans == JOptionPane.YES_OPTION){
            try {
                ...
                conn=methods.getConnection();
                String deleteqry = "DELETE * FROM bank WHERE ID="+txtgroupid.getText()+";";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            // Insert new Record
            if(framestate==1){
                String insertqry = "INSERT INTO bank (bankname, branch, ifsccode) VALUES ('"+txtgroup.getText().toString()+"', '"+txtgroup1.getText().toString()+"', '"+txtgroup2.getText().toString()+"')";
            ...
            if(framestate==2){
                String updateqry = "UPDATE bank SET bankname = '"+txtgroup.getText()+"', branch = '"+txtgroup1.getText()+"', ifsccode = '"+txtgroup2.getText()+"' WHERE ID = "+txtgroupid.getText()+";";

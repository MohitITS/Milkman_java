...
/*    private TextArea messageAreaOut;
    ...
    */
    public SerialConnection(SerialParameters parameters) throws ClassNotFoundException{
...
//       }
	...
	try {
            //JOptionPane.showMessageDialog(null, parameters.getPortName());
	    //portId = CommPortIdentifier.getPortIdentifier(parameters.getPortName());
            
            portId = CommPortIdentifier.getPortIdentifier(methods.comportno);
...
//                    if (portId.getName().equals(methods.comportno)) {
...
//            }
        ...
        //JOptionPane.showMessageDialog(null, portId);
	...
	try {
            if (portId.isCurrentlyOwned()) {
                ...
                sPort = (SerialPort)portId.open("SMSConnector", 3000);
            }
            //System.out.println("SerialConnection : " + sPort);
	...
	try {
        ...
        //JOptionPane.showMessageDialog(null, "OK 4 ");
/*
...
*/
	...
	try {
        ...
        //JOptionPane.showMessageDialog(null, "OK 5 ");
	...
	try {
        ...
        //JOptionPane.showMessageDialog(null, "OK 6 ");
...
//            System.out.println(portId.isCurrentlyOwned());
        ...
        //sPort = null;
	open = false;
        System.out.println("sPort Closed");
    }
        ...
        public void send(String message) {
	      ...
	      try {
	    	os.write((int)newCharacter);
                  ...
                  System.err.println("OutputStream write error: " + e);
                  //JOptionPane.showMessageDialog(null, "OutputStream write error: " + e);
              }

...
public class vehical extends javax.swing.JInternalFrame {
    ...
    private void displayrecord(int flag) {
        if(framestate==3){
            try {
                ...
                String qry = null;
                if(flag==4){
                   qry = "SELECT * FROM vehical WHERE ID=(SELECT max(ID) FROM vehical);";
                }
                if(flag==1){
                   qry = "SELECT * FROM vehical WHERE ID=(SELECT min(ID) FROM vehical);";
                }
                if(flag==2){
                   qry = "SELECT * FROM vehical WHERE ID<"+txtgroupid.getText()+" ORDER BY ID DESC;";
                }
                if(flag==3){
                   qry = "SELECT * FROM vehical WHERE ID>"+txtgroupid.getText()+" ORDER BY ID;";
                }                
                ...
                while(rs.next()){
                    ...
                    String grpname = rs.getString("vehicalname");
        ...
        if(!txtgroupid.getText().equals("")) {
            ...
            if(ans == JOptionPane.YES_OPTION){
                try {
                    ...
                    conn=methods.getConnection();
                    String deleteqry = "DELETE * FROM vehical WHERE ID="+txtgroupid.getText()+";";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            // Insert new Record
            if(framestate==1){
                String insertqry = "INSERT INTO vehical (vehicalname) VALUES ('"+txtgroup.getText().toString()+"')";
            ...
            if(framestate==2){
                String updateqry = "UPDATE vehical SET vehicalname = '"+txtgroup.getText()+"' WHERE ID = "+txtgroupid.getText()+";";

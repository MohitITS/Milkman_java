...
public class Sender implements Runnable  {
  ...
  // +919846000040 -> Vodafone
  
  
  private SerialParameters defaultParameters = new SerialParameters (methods.comportno,9600,0,0,8,1,0);
  public int step;
  public int status=-1;
      ...
      try {
            ...
            switch (step){
              ...
              case 1:
                delay=STANDARD;
                mySerial.send("ath0");
                if (methods.CSCS_command) mySerial.send("AT+CSCS=\"GSM\"");
                startTime=(new Date()).getTime();
                break;
              case 2:
 ...
 */
  private void log(String s){
        ...
        //JOptionPane.showMessageDialog(null, new java.util.Date()+":"+this.getClass().getName()+":"+s);
  }
}